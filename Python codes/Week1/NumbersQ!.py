# Get age(int), dob(str of format "dd/mm/yy")
# and weight(float) from the standard input and print the tenth_month, f
# ifth_birthday and last_birthday formatted as "day/month/year"(do not include the preceeding zero for
# single digit number) separated by comma and a space a single line and print the
# weight_readable(str formatted as "55 kg 200 grams")
